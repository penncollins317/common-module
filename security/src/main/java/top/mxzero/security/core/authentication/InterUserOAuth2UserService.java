...
import top.mxzero.common.utils.RandomUsernameGenerator;
...
public class InterUserOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest userRequest, OAuth2User oAuth2User) {
        ...
        if (OAuth2Provider.GITHUB.getValue().equals(registrationId)) {
            oauth2UserId = (String) attributes.get("sub");
        } else if (OAuth2Provider.QQ.getValue().equals(registrationId)) {
