package top.echovoid.security.apikeys.utils;
...
public class SignatureUtil {
     ...
     */
    public static boolean validateSignature(Map<String, String> queryParams, Map<String, Object> body, String secretKey, Long timestamp, String nonce, String providedSignature) {
        // 将请求参数按键排序并拼接
        Map<String, String> sortedQueryParams = new TreeMap<>(queryParams);
        StringBuilder sortedQueryString = new StringBuilder();
        for (Map.Entry<String, String> entry : sortedQueryParams.entrySet()) {
        ...
        try {
            // 将请求体转换为 JSON 字符串
            String bodyString = OBJECT_MAPPER.writeValueAsString(new TreeMap<>(body));
